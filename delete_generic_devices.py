# This script deletes all devices in LibreNMS with the Operating System set to 'Generic Device'.
import requests
...
def get_generic_devices():
    ...
    generic_devices = [device for device in all_devices if device.get('os') == 'generic']  #modify 'generic' to any other OS you want to target for deletion
